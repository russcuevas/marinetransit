...
<body>
    ...
    <div class="hero">
        <section class="home-slider owl-carousel">
            <div class="slider-item" style="background-image:url(images/bg/bg.jpg);">
                ...
                <div class="container">
                    <div class="row no-gutters slider-text align-items-center justify-content-end">
                        <div class="col-md-6 ftco-animate">
                            <div class="text">
                                <h2>Marinetransit</h2>
                                <h1 class="mb-3">Port transportation
                                    Efficiency through technology</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="slider-item" style="background-image:url(images/bg/bg2.jpg);">
                ...
                <div class="container">
                    <div class="row no-gutters slider-text align-items-center justify-content-end">
                        <div class="col-md-6 ftco-animate">
                            <div class="text">
                                <h2>Inspired travelers</h2>
                                <h1 class="mb-3">YOUR TICKET TO BALINGOAN ADVENTURES</h1>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md d-flex">
                                <div class="form-group d-flex align-self-stretch">
                                    <a href="booknow.php"
                                        class="btn btn-primary py-5 py-md-3 px-4 align-self-stretch d-block"><span>BOOK
                                            NOW <small>Best Price Guaranteed!</small></span></a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row d-flex">
                ...
                <div class="col-md pl-md-1 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block text-center">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3">Safety</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row no-gutters ftco-animate justify-content-center">
                <div class="col-md-5 d-flex">
                    <div class="testimony-img aside-stretch-2" style="background-image: url(images/bg/width_800.jpeg);">
                    </div>
                </div>
