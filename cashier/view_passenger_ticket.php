    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <a href="print/print_passenger_ticket.php?ticket_code=<?php echo $ticket['ticket_code']; ?>" class="btn btn-primary" id="print" target="_blank"><i class="fas fa-print"></i> </a>
            </div>
            <div class="py-3 px-0 my-3" style="border: 1px solid black; color: black">
                ...
                <div style="display: flex; margin-bottom: 10px">
                    ...
                    <div class="col-xl-4 col-md-4">
                        <p class="m-0" style="font-weight: bold">Contact No.: <?php echo htmlspecialchars($ticket['contact_number']); ?>
                        </p>
                        <p class="m-0" style="font-weight: bold">Email Address: <?php echo htmlspecialchars($ticket['contact_email']); ?>
                        </p>
                    </div>
                    <div class="col-xl-4 col-md-4">
                ...
                <div style="display: flex;">
                    ...
                    <div class="col-xl-4 col-md-4">
                        <p class="m-0" style="font-weight: bold">Ticket Price: <?php echo htmlspecialchars($ticket['total_ticket_price']); ?> - Php
                        </p>
                    </div>
                    <div class="col-xl-4 col-md-4">
